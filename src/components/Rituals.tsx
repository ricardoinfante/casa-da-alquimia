  ...
  return <section id="rituals" className="py-12 md:py-20 bg-gradient-to-b from-muted/50 to-background overflow-hidden">
      <div className="section-container relative">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10">
          ...
          <p className="text-foreground/80 text-lg">Se você encontrou a sua verdade dentro você, não há mais nada para descobrir em toda esta existência. A verdade está atuando através de você. Quando você abre os olhos, é a verdade abrindo os olhos. Quando fecha os seus olhos, é a verdade que está fechando os olhos.” - OSHO
        </p>
        </div>
        ...
        }].map((ritual, index) => <div key={index} className="group bg-white/40 backdrop-blur-sm rounded-xl overflow-hidden border border-muted shadow-sm transition-all duration-500 hover:shadow-md hover:bg-white/60">
