      ...
      <div className="section-container">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
          <div className="lg:w-1/2 space-y-6">
            ...
            <p className="text-foreground/80 text-lg leading-relaxed">A Casa da Alquimia é um espaço sagrado e transformador, guiado pelo propósito de promover a cura, o autoconhecimento e a conexão espiritual por meio da Medicina Sagrada da Ayahuasca. Como uma associação sem fins lucrativos, somos movidos pelo desejo genuíno de servir à verdade, à luz e ao bem-estar de cada ser que se une a nós nessa jornada. Nosso compromisso está alicerçado em pilares sólidos que perpassam áreas essenciais da vida, como música, meditação, terapias, yoga, reinados, culinária, permacultura, educação, retiros e artes. Acreditamos na força unificadora desses elementos, que, em harmonia, criam um ambiente propício à transformação interior e à elevação da consciência. 


Na Casa da Alquimia, cada ritual é uma celebração da vida e um convite ao reencontro com a essência divina que habita em cada um de nós. Nossa missão é honrar e expandir os conhecimentos ancestrais que nos foram transmitidos, integrando práticas de cura profunda, autocuidado e crescimento espiritual. Aqui, você encontrará um espaço acolhedor, dedicado ao despertar do potencial humano e à comunhão com a Mãe Terra, em todos os seus aspectos. 


Venha conhecer nosso trabalho e embarque em uma experiência que transcende o individual, conectando-nos ao coletivo e ao sagrado, em um caminho de amor, verdade e harmonia.</p>
          </div>
